package com.nutiteq.app.settings.froyo.and.gingerbread;
...
public class SettingsActivity9 extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.preferences9);
        ...
        unit.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference,
                ...
                ((MapApplication) getApplication()).getLocationTrackingDB()
        ...
        final CheckBoxPreference brightStyle = (CheckBoxPreference) findPreference(Const.PREF_BRIGHT_STYLE);

        brightStyle.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object object) {
                MainActivity.setShouldUpdateBaseLayer(true);

                if (object.toString().equals("true")) {
                    MainActivity.setIsNotDarkStyle(false);
                } else if (object.toString().equals("false")) {
                    MainActivity.setIsNotDarkStyle(true);
                }
        ...
        final CheckBoxPreference buildings3D = (CheckBoxPreference) findPreference("pref_buildings_3d");
